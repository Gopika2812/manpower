  ...
  return (
    <section id="hero" className="hero-section">
      ...
      <div className="hero-content">
        <h1 className="hero-title">WELCOME TO SUCCESS MANPOWER SOLUTIONS</h1>
        <p className="hero-tagline">Your Trusted Partner in Manpower Services</p>
      ...
      <div className="about-container">
        ...
        <div className="about-content">
          <div className="about-text-content">
            <h3 className="about-subheading">Success Manpower Solutions (SMS)</h3>
            <div className="service-details">
              <div>
                <p className="service-paragraph">
                  Success Manpower Solutions (SMS) is dedicated to connecting businesses with the right talent and individuals with the right opportunities. With a strong focus on professionalism, reliability, and care, we provide skilled manpower across multiple sectors, ensuring growth and success for both our clients and workforce.Empowering our businesses with manpower recruitment and dedicated professionals across various industries.
                </p>
              </div>
            </div>
          </div>
...
const ServicesSection = () => {
  const jobs = [
    { title: "Sales & Marketing", image: "/images/sales.jpeg" },
    { title: "Accountant", image: "/images/accountant.jpeg" },
    { title: "Receptionist", image: "/images/receptionist.jpg" },
    { title: "Degree Holder", image: "/images/degree.png" },
    { title: "Housekeeping", image: "/images/housekeeping.jpg" },
    { title: "Cook", image: "/images/cook.jpg" },
    { title: "Nurse", image: "/images/nurse.jpeg" },
    { title: "Hotel Management", image: "/images/hotel.webp" },
  ];
  return (
